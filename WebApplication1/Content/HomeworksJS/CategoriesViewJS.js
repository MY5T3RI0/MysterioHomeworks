$(function () {
    ...
    newCatA.click(function (e) {
        ...
        var url = "/admin/Homeworks/AddNewCategory";
        ...
        $.post(url, { catName: catName }, function (data) {
            ...
            if (response == "titletaken") {
                ...
                if (!$("table#pages").length) {
                    ...
                    toAppend.find("a.delete").attr("href", "/admin/Homeworks/DeleteCategory/" + data);
    ...
    $("body").on("click", "a.delete", function () {
        if (!confirm("Confirm the category deletion")) return false;
    ...
    $("table#pages input.text-box").blur(function () {
        ...
        var url = "/admin/Homeworks/RenameCategory";
    ...
    $("table#pages tbody").sortable({
        ...
        update: function () {
            ...
            var url = "/Admin/Homeworks/ReorderCategories";
